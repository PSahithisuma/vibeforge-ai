#!/usr/bin/env bash
# =============================================================================
# 00_create_dbs.sh — Create sibling databases for Keycloak and Langfuse.
#
...
echo "[init] Creating sibling databases: keycloak, langfuse"
...
echo "[init] Sibling databases ready."
